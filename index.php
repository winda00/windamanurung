...
<div class="copy-right">
	<div class="container">
		...
		<p class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">© 2019 Rental Mobil Online . All Rights Reserved | Design by  <a href="http://w3layouts.com/" target="_blank">WindaMayaManurung</a> </p>
	</div>
</div>
<!--- /copy-right ---->
<!-- sign -->
